...
<body>
    <?php
        ...
        $donation_result = mysqli_query($link, $find_donation);
        echo"<div class='container text-center'><table class='table table-hover table-borderless'><tr>";
        echo"<th class='align-middle'>捐款人姓名</th>";
        echo"<th class='align-middle'>捐款日期</th>";
        echo"<th class='align-middle'>捐款金額</th>";
        echo"<th class='align-middle'>備註</th>";
        echo"</tr>";
        while($donation_array = mysqli_fetch_array($donation_result)){
            echo"<tr>";
            $member_id = $donation_array['member_id'];
            $donation_id = $donation_array['donation_id'];
